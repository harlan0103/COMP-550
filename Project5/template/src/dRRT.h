    ...
    namespace geometric
    {
        ...
        */
        ...
        public:
            ...
            void getRoadMap(std::vector<const ompl::base::State*> &roadMap);

            void getRoadMapData(std::shared_ptr<ompl::base::PlannerData> roadMapData)
            {
        ...
        protected:
            ...
            /** \brief The structure contains all composite vertex of the graph */
            std::vector<const ompl::base::State*> roadMap;

            std::shared_ptr<ompl::base::PlannerData> roadMapData;
        };
    }
}
